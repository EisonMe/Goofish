...
import { processAutoSell, recordAutoSellDeliveryLog, rollbackAutoSellReservation } from './autosell.service.js'
...
async function executeDeliveryNode(
    ...
    if (!sendResult) {
        rollbackAutoSellReservation(context.orderId, result)
